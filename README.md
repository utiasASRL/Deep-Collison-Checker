...
| :--- | :---: | :---: | :---: | 
| Mapping session  | ~110MB | [link]() | `wget ftp://asrl3.utias.utoronto.ca/2021-Myhal-Simulation/mapping_session.zip` | 
| Bouncers sessions | ~13GB | [link](https://drive.google.com/file/d/14sKVC3UnxmLTbJi3IJcFGhGPMTDKNWq9/view?usp=sharing) | `wget ftp://asrl3.utias.utoronto.ca/2021-Myhal-Simulation/bouncers_sessions.zip` | 
| Wanderers sessions  | ~14GB | [link]() | `wget ftp://asrl3.utias.utoronto.ca/2021-Myhal-Simulation/wanderers_sessions.zip` | 
| Flow Followers sessions | ~9GB | [link]() | `wget ftp://asrl3.utias.utoronto.ca/2021-Myhal-Simulation/flow_followers_sessions.zip` | 
